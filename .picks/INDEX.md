...
|------|-----------|-------|---------|------|------|-----------|-------------|--------|------------|------------|-------|
| 2026-05-12 | Official | MLB | Tampa Bay Rays at Toronto Blue Jays | Tampa Bay Rays ML | Medium | -115 | -130 / 0.56 PM | Pending | — | — | Console pick `3790fcfb-f4df-4c8c-ab36-6db46068ce36`; Polymarket filled order `9ZHTBEX0014N`: 28 shares at 0.520, receipt `20260512-200447-sdk-order-aec-mlb-tb-tor-2026-05-12.json`. |
